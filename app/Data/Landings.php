    ...
    private static function definitions(): array
    {
        return [
            [
                ...
                'services_intro' => 'Le prix d’une prestation de correction dépend de nombreux critères, parmi lesquels la <strong>taille du manuscrit</strong> ou encore le <strong>degré de profondeur</strong> attendu (style, typographie, cohérence, etc.). L’avantage sur Acteurs du Livre, c’est que vous partez d’un devis personnalisé, et que vous validez chaque étape du projet avec votre prestataire ; <strong>garantie de confiance pour tous les deux</strong>.',
                'services_cta' => 'Trouver un correcteur adapté',
                'providers_title' => 'Correctrices & correcteurs',
                'providers_bridge' => 'Sur Acteurs du Livre, vous pouvez contacter n’importe quel correcteur pour <strong>demander plus d’informations</strong>, <strong>discuter d’un prix</strong>, ou pour <strong>en savoir plus sur le déroulement d’une prestation</strong>. Notre plateforme vous permet de faire un choix éclairé, adapté à vos besoins et à vos priorités.',
