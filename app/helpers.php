...
function icon(string $name, int $size = 20): string
{
    ...
    $paths = [
        ...
        'trade-beta' => '<path d="M2.6 5.2C5.4 3.8 8.6 3.9 12 5.7c3.4-1.8 6.6-1.9 9.4-.5V20c-3-1.2-6.2-1-9.4 1.5-3.2-2.5-6.4-2.7-9.4-1.5V5.2zm2.4 1.9v11.1c2-.2 4.3.2 6.6 1.5V8.6C9.4 7.4 7.1 7 5 7.1zm14.4 0c-2.1-.1-4.4.3-6.6 1.5v10.9c2.3-1.3 4.6-1.7 6.6-1.5V7.1z"/>',
        'trade-illustration' => '<path fill-rule="evenodd" d="M12 2a10 10 0 0 0 0 20h.8c1.5 0 2.4-1.3 1.7-2.6-.5-.9.2-1.9 1.2-1.9H17a4 4 0 0 0 4-4.1C21 6.5 17.1 2 12 2zM7.3 11.4a1.6 1.6 0 1 1 0-3.2 1.6 1.6 0 0 1 0 3.2zm3.5-3.8a1.6 1.6 0 1 1 0-3.2 1.6 1.6 0 0 1 0 3.2zm4.6 0a1.6 1.6 0 1 1 0-3.2 1.6 1.6 0 0 1 0 3.2zM16.8 12a1.6 1.6 0 1 1 0-3.2 1.6 1.6 0 0 1 0 3.2z"/>',
        'trade-traduction' => '<path d="M4.8 3.4h2.6L12 16h-2.5l-1-2.8H5.3L4.3 16H1.8L4.8 3.4zm.8 7.4h3.2L7.2 6.6 5.6 10.8zM14.2 7h8.2v2h-2.8l2.6 3.6H22v2h-5.4l2.6 3.6h-2.6L14.2 14H19l-2.6-3.6h2.2V9h-4.4V7z"/>',
        'trade-maquette' => '<path d="M3 3h18v18H3V3zm2 2v6h8V5H5zm10 0v14h4V5h-4zM5 13v6h8v-6H5z"/>',
        'trade-edition' => '<path d="M4 3.4h11.4A2.6 2.6 0 0 1 18 6v14.6H6.2A2.2 2.2 0 0 0 4 18.4V3.4zm2 2v13c0 .1.1.2.2.2H16V6a.6.6 0 0 0-.6-.6H6zm12 0h2v16h-2V5.4zM7.4 8.2h7v1.8h-7V8.2zm0 3.4h7v1.8h-7v-1.8z"/>',
        'trade-impression' => '<path d="M7 3h10v5.2H7V3zM4 9h16a2 2 0 0 1 2 2v6.4h-4V22H6v-4.6H2V11a2 2 0 0 1 2-2zm3 11h8v-3.2H7V20zm11.4-6.8a1.1 1.1 0 1 0 0-2.2 1.1 1.1 0 0 0 0 2.2z"/>',
        'trade-presse' => '<path d="M14 4v16l-6.2-3.4H5a2 2 0 0 1-2-2v-5.2a2 2 0 0 1 2-2h2.8L14 4zm2 3.4 4.4-1.6v12.4L16 16.6V7.4zM7.8 18.2 7 21h3.4l.6-2.2-3.2-.6z"/>',
        'trade-librairie' => '<path d="M3 9.2 6.4 3.8h11.2L21 9.2V10.6H3V9.2zM5 12h3.2v8H5v-8zm10.8 0H19v8h-3.2v-8zM9.4 12h5.2v3.8H9.4V12zm0 5h5.2v3H9.4v-3z"/>',
        'trade-audio' => '<path d="M12 3a8 8 0 0 0-8 8v5.4A3.6 3.6 0 0 0 7.6 20H9.2v-7.2H6.2V11a5.8 5.8 0 1 1 11.6 0v1.8H14.8V20h1.6A3.6 3.6 0 0 0 20 16.4V11a8 8 0 0 0-8-8z"/>',
        'trade-agent' => '<path d="M8 6.2V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1.2h5V21H3V6.2h5zm2 0h4V5h-4v1.2zM5 10.6h14v2.2H5v-2.2z"/>',
        'trade-coach' => '<path d="M12 2.2A6.2 6.2 0 0 1 18.2 8.4c0 2.5-1.4 4.3-2.9 5.5v2.3H8.7v-2.3c-1.5-1.2-2.9-3-2.9-5.5A6.2 6.2 0 0 1 12 2.2zM9.2 18.2h5.6v1.5H9.2v-1.5zm1 2.4h3.6V22h-3.6v-1.4z"/>',
        'trade-iconographie' => '<path d="M3 4.8h18v14.4H3V4.8zm2 2v8.2l3.8-3.8 2.8 2.8 4.4-5.4L19 12.6V6.8H5zm3.2 2.4a1.4 1.4 0 1 1 0-2.8 1.4 1.4 0 0 1 0 2.8z"/>',
        'trade-lecture' => '<path d="M5.6 2h8.6L20 7.8V13h-2V8.6h-5.2V3.8H7.6v16.4h4.6v2H5.6V2zm11.2 12a3.2 3.2 0 1 1 2.2 5.5l2.5 2.5-1.4 1.4-2.5-2.5a3.2 3.2 0 0 1-4-4.5 3.2 3.2 0 0 1 3.2-2.4zm0 2a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4z"/>',
        'trade-photo' => '<path d="M8.6 4h6.8l1.4 2.2H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.2a2 2 0 0 1 2-2h3.2L8.6 4zM12 17.4A4.4 4.4 0 1 0 12 8.6a4.4 4.4 0 0 0 0 8.8zm0-2.2a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4z"/>',
        'trade-reliure' => '<path d="M4.2 3h3.4v18H4.2V3zm4.4 0h11.2v18H8.6V3zm2.2 3.4h6.8v1.8h-6.8V6.4zm0 3.8h6.8v1.8h-6.8V10.2zm0 3.8h5v1.8h-5v-1.8z"/>',
        'trade-juridique' => '<path d="M11.1 2.4h1.8v2.1l7.5 2.5-.6 1.8L12.9 6.6v11h2.8v1.8H8.3v-1.8h2.8V6.6L4.2 8.8l-.6-1.8 7.5-2.5V2.4zM3.2 15 7 9.8 10.8 15H3.2zm10 0 3.8-5.2 3.8 5.2h-7.6z"/>',
    ];
