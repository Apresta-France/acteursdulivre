...
<div class="espace-page">
  ...
  <?php if ($orders === []): ?>
    <div class="search-empty">
      ...
      <span>Le suivi à jalons apparaîtra dès qu’une commande sera ouverte. Aucun paiement n’est encaissé ici.</span>
    </div>
  <?php else: ?>
      ...
      <?php foreach ($orders as $order): ?>
        <article class="side-card">
          ...
          <div class="auth-actions" style="margin-top: 14px;">
            ...
            <?php if (!empty($order['can_validate']) && (int) ($order['buyer_id'] ?? 0) === (int) (\Adl\Core\Auth::id() ?? 0)): ?>
