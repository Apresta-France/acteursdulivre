<div class="legal-page" style="max-width: 640px; padding: 48px 24px 72px;">
  ...
  <?php else: ?>
    <p style="font-size: 16px; color: #4A5A6B; line-height: 1.65;">Ce lien de désinscription n’est pas reconnu. Écrivez-nous à <a href="mailto:bonjour@acteursdulivre.fr">bonjour@acteursdulivre.fr</a> si le problème continue.</p>
  <?php endif; ?>
