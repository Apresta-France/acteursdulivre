...
return static function (Router $router): void {
    ...
    $router->get('/api/forum/recherche', [ForumController::class, 'searchApi']);
    ...
    $router->post('/forum/nouveau', [ForumController::class, 'create']);
    $router->get('/forum/{slug}', [ForumController::class, 'category']);
    $router->get('/forum/{slug}/{topic}', [ForumController::class, 'topic']);
    $router->post('/forum/{slug}/{topic}/repondre', [ForumController::class, 'reply']);
    ...
    $router->get('/espace/forum', [AccountController::class, 'forumEspace']);
    $router->post('/espace/forum', [AccountController::class, 'forumSave']);
    $router->post('/espace/forum/unfollow/{id}', [AccountController::class, 'forumUnfollow']);
    ...
    $router->get('/admin/newsletter/nouvelle', [AdminController::class, 'newsletterLetterEdit']);
    $router->post('/admin/newsletter/nouvelle', [AdminController::class, 'newsletterLetterSave']);
    $router->post('/admin/newsletter/depuis-hebdo', [AdminController::class, 'newsletterFromWeekly']);
    $router->post('/admin/newsletter/image', [AdminController::class, 'newsletterLetterImage']);
    ...
    $router->post('/admin/newsletter/lettre/{id}/envoyer', [AdminController::class, 'newsletterLetterSend']);
    $router->post('/admin/newsletter/lettre/{id}/supprimer', [AdminController::class, 'newsletterLetterDelete']);
